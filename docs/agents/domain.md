...
├── CONTEXT.md
├── docs/adr/
│   ├── 0001-retrieval-first-never-generate-folds.md
│   ├── 0002-one-test-seam-in-the-core-package.md
│   └── 0003-diagrams-are-composed-from-primitives.md
├── packages/core/
├── apps/api/
└── apps/web/
```
...
(`pattern`, `tutorial`, `recipe`, `generate`).
...
> _Contradicts ADR-0001 (retrieval-first), but worth reopening because…_
